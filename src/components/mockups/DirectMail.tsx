...
export function PostcardMockup({ companyName, logoDataUrl, primaryColor, secondaryColor, tagline, animated }: BrandProps) {
  return (
    <div
...
export function SelfMailerMockup({ companyName, logoDataUrl, primaryColor, secondaryColor, tagline, animated }: BrandProps) {
  return (
      ...
      <div className="flex rounded-xl overflow-hidden w-[510px] h-[220px] shadow-2xl">
        ...
        <div className="w-[170px] h-full p-5 flex flex-col justify-between relative overflow-hidden" style={{ background: primaryColor }}>
          ...
          <div className="relative z-10" style={anim('0.4s', animated)}>
            <div className="text-white font-bold text-xl leading-tight mb-1">{companyName}</div>
...
export function LetterMockup({ companyName, logoDataUrl, primaryColor, secondaryColor, tagline, animated }: BrandProps) {
  return (
